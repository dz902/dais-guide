...
* __仅限企业__。个人用户无法注册使用。
* __必须备案__。客户必须进行网站 ICP 备案，才能启用 Web 端口，否则会返回 `403`。

### 区域隔离

* __网络不互通。__宁夏、北京 Region（下简称「中国大陆 Region」）与其他 Region 没有亚马逊官方的光纤直联。
* __账号不互通。__中国大陆 Region 与其他 Region 的账号不处于同一体系。
* __资源不互通__。ARN 中的第二段由「aws」改为「aws-cn」，与 Global 资源不在一个体系。
